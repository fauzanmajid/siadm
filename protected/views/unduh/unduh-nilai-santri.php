...
?>
<h1>Unduh Nilai Santri</h1>

<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'unduh-nilai-santri',
...
<?php echo $form->errorSummary($model); ?>
	...
	<div class="row">
		<?php echo 'Mata Pelajaran'; ?>
		<?php echo $form->dropDownList($model,'mata_pelajaran',array('IPA'=>'IPA', 'IPS'=>'IPS', 'Matematika'=>'Matematika', 'Bahasa Inggris'=>'Bahasa Inggris', 'Bahasa Indonesia'=>'Bahasa Indonesia', 'Bahasa Arab'=>'Bahasa Arab', 'Agama Islam'=>'Agama Islam'), array('empty'=>'--Pilih Kelas--')); ?>
