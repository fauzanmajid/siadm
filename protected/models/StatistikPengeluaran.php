 ...
 */
class StatistikPengeluaran extends CActiveRecord
{
	/**
	...
	{
		return 'statistik_pengeluaran_final';
	}
	...
	public function search()
	{
		...
		$criteria->compare('Jumlah_Pengeluaran',$this->jumlah_pengeluaran,true);
