...
class UserWeb extends CWebUser {
    ...
    public function isAdmin() {
        $user = $this->loadUser();
        return $user && !UserWeb::instance()->isGuest && $user->role == 'Admin';
    }
    ...
    public function isBendahara() {
        $user = $this->loadUser();
        return $user && !UserWeb::instance()->isGuest && $user->role == 'Bendahara';
    }
    ...
    public function isKesiswaan() {
        $user = $this->loadUser();
        return $user && !UserWeb::instance()->isGuest && $user->role == 'Kesiswaan';
    }
    ...
    public function isKurikulum() {
        $user = $this->loadUser();
        return $user && !UserWeb::instance()->isGuest && $user->role == 'Kurikulum';
    }
    ...
    public function isGuru() {
        $user = $this->loadUser();
        return $user && !UserWeb::instance()->isGuest && $user->role == 'Guru';
    }
