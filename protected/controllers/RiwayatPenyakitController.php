...
class RiwayatPenyakitController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('RiwayatPenyakit');

		$model=new RiwayatPenyakit('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['RiwayatPenyakit']))
			$model->attributes=$_GET['RiwayatPenyakit'];
	...
	{
		$model=RiwayatPenyakit::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param RiwayatPenyakit $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='riwayat-penyakit-form')
		{
