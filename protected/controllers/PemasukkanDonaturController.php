...
class PemasukkanDonaturController extends Controller
{
	/**
	...
	{
		$model=new PemasukkanDonatur;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['PemasukkanDonatur']))
		{
	 ...
	 * @return PemasukkanDonatur the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=PemasukkanDonatur::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param PemasukkanDonatur $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='pemasukkan-donatur-form')
		{
